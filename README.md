...
[![Latest Release](https://github.com/ashisha7i/uscis-civics-desktop-cards/releases/latest/download/USCIS-Civics-Flashcards-Mac-AppleSilicon.zip)](https://github.com/ashisha7i/uscis-civics-desktop-cards/releases/latest)

---

## ✨ Features

* **🔄 Cinematic 3D Card Flip**: Click anywhere on the card layout or tap the **SPACEBAR** to smoothly flip between the question prompt and the official answers.
...
* **⭐ Revisit Question Bank**: Flag difficult or missed questions with a single click. Filter your study deck instantly into an isolated "Review Mode" to tackle your weak spots.
